...
func TestApplyRefusesInteractiveOperations(t *testing.T) {
	...
	for _, excluded := range []string{"twt next", "twt tickets start", "twt tickets home", "twt switch", "twt done", "twt archive", "twt templates edit", "twt agents focus", "twt agents open", "twt agents register --pane current"} {
