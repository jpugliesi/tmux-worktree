...
type Store interface {
	...
	PauseProject(name string, dryRun bool) (domain.Project, error)
	ResumeProject(name string, dryRun bool) (domain.Project, error)
	PlanProjectRemoval(name string) (ProjectRemovalPlan, error)
	...
	AddLabel(name string, refs []string, dryRun bool) (LabelChangeResult, error)
	RemoveLabel(name string, refs []string, dryRun bool) (LabelChangeResult, error)
	RenameLabel(oldName, newName string, dryRun bool) (LabelChangeResult, error)
